 ...
 */
Route::set('about', 'about(/<id>)', array('id'	=>	'([a-z]+)'))
	->defaults(array(
		'controller'	=> 'site',
		'action'	=> 'index'
	));

Route::set('blog-post', 'post(/<id1>(/<id2>))', array(	'id1' => '([0-9a-zA-Z]+)',
														'id2' => '([0-9a-zA-Z\-]+)'
			))
	->defaults(array(
		'controller'	=> 'blog',
...
Route::set('blog-category', 'category(/<id>)', array('id' => '([0-9a-zA-Z]+)',
			))
	->defaults(array(
		'controller'	=> 'blog',
		'action'	=> 'category'
...
Route::set('blog-tag', 'tag(/<id>)', array('id' => '([0-9a-zA-Z]+)',
			))
	->defaults(array(
		'controller'	=> 'blog',
		'action'	=> 'tag'
...
Route::set('blog-feed', 'feed(/<action>(/<id>))', array('id' => '([0-9a-zA-Z\-]+)',
			))
	->defaults(array(
		'controller'	=> 'feed',
		'action'	=> 'index'
