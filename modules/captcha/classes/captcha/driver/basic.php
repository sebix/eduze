 ...
 */
class Captcha_Driver_Basic extends Captcha_Driver {
    ...
    public function render($html)
    {
        ...
        for ($i = 0, $count = mt_rand(5, Captcha::$config['complexity'] * 4); $i < $count; $i++)
        {
            ...
            imagearc($this->image, mt_rand(10, Captcha::$config['width']), mt_rand(30, Captcha::$config['height']), mt_rand(30, Captcha::$config['width']), mt_rand(10, Captcha::$config['height']), mt_rand(100, 360), mt_rand(100, 360), $color);
        }
